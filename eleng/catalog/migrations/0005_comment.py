...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('catalog', '0004_alter_article_photo'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='catalog.comment', verbose_name='Родительский комментарий')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='catalog.article', verbose_name='Изделие')),
            ],
            options={
